...
public class JpaOrderRepository implements OrderRepository {
    ...
    @Override
    public Order save(Order order) { return spring.save(order); }

    @Override
    public Optional<Order> findById(Long id) { return spring.findById(id); }

    @Override
    public Page<Order> findAll(Pageable pageable) { return spring.findAll(pageable); }

    @Override
    public Page<Order> findByClientId(Long clientId, Pageable pageable) { return spring.findByClientId(clientId, pageable); }

    @Override
    public Page<Order> findByStatus(OrderStatus status, Pageable pageable) { return spring.findByStatus(status, pageable); }
